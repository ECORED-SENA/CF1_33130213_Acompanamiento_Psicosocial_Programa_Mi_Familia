  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Las bases de Mi Familia
        p.mb-4 #[b Objetivo] Fortalecer el ejercicio del Profesional de Acompañamiento Familiar, comprendiendo a cabalidad el marco normativo y conceptual del programa Mi Familia.
